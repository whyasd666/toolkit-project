...
- **Cybersecurity lessons** (SQL Injection, XSS, Phishing, Password Security, Wi‑Fi Security) with detailed content.
- **Interactive frontend**: lesson cards, full‑page lesson view, dark/light theme toggle.
- **User authentication** (localStorage‑based) –  account included.
- **Telegram bot** that:
